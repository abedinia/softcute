	...
	<div id="demo" class="box jplist" style="margin: 20px 0 50px 0">
		...
		<div class="jplist-panel box panel-top">						
			...
			<button 
				...
				حذف تغیرات &nbsp;<i class="fa fa-share"></i>
			</button>
			...
			<div 
			   ...
			   <ul>
				 <li><span data-number="3"> نمایش 3 تایی  </span></li>
				 <li><span data-number="5"> نمایش 5 تایی </span></li>
				 <li><span data-number="10" data-default="true"> نمایش 10 تایی </span></li>
				 <li><span data-number="all"> نمایش همه  </span></li>
			   </ul>
			</div>
			...
			<div 
				...
				<ul>
					<li><span data-path="default">پیش فرض</span></li>
					<li><span data-path=".like" data-order="asc" data-type="number" data-default="true">محبوبیت</span></li>
					<li><span data-path=".date" data-order="asc" data-type="datetime">تاریخ صعودی</span></li>
					<li><span data-path=".date" data-order="desc" data-type="datetime">تاریخ نزولی</span></li>
				</ul>
			</div>
